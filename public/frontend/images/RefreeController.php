...
class RefreeController extends Controller
{
    ...
    public function index()
    {
        ...
        $id = Auth::user()->id;
        return view('refrees.list', compact('uprofile', 'usportcert', 'usportmem'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.refrees.create',compact('data','competitions','countries','sports','usportlevel','usportattitude','ufplayers','ufavteam'));
    }
    public function store(Request $request)
    {
        ...
        $usersport_certification->name = $request['name'];
        $usersport_certification->description = $request['description'];
