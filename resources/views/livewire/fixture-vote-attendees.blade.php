        ...
        <div class="col-md-5 col-6 position-relative">
            @if ($fixture_squad_teamOne->isEmpty())
                    ...
                    <div class="player-jersy-list">
                        <div class="jersy-img-wrap mb-2">
                            ...
                            <span class="jersy-no team-jersy-left jersy1">
                                @if ($team_member->jersey_number){{ $team_member->jersey_number }}
                                @else
                                @endif
                            </span>
                            <div class="jersy-img">
                ...
                <div class="overlay-button">
                    <button class="btn btn-green" style="background-color:{{ $teamOne->team_color }};">Coming Soon..</button>
                </div>
            @else
                    ...
                    <div class="col-md-12 col-12 ">
                        @foreach ($subplyr1 as $tm1)
                            ...
                            <div class="player-jersy-list " data-id="{{ $tm1->player_id }},{{ $teamOne->id }}">
                                ...
                                <div class="jersy-plyr-title d-flex">
                                    <div class="playerNme">{{ $tm1->player->first_name }} {{ $tm1->player->last_name }}</div>
                                </div>
                            </div>
                        @endforeach
                    </div>
                ...
                <a href="{{ url('player_profile/' . $refree->id) }}" target="a_blank">
                    <div class="player-refer-bottom text-center">
                        <div class="crop-circle">
                            <img src="{{ asset('frontend/profile_pic') }}/{{ $refree->profile_pic }}" alt="" class="img-fluid">
                        </div>
        ...
        @if ($match_fixture->finishdate_time == null)
            <div class="col-md-5 col-6 position-relative">
                ...
                <div class="player-jersy-list">
                    ...
                    <div class="jersy-img-wrap mb-2">
                        ...
                        <div class="jersy-img">
                            <img class="img-fluid" src="{{ url('frontend/images/football.png') }}" alt=""
                                height="100">
                        </div>
                    </div>
                    <div class="jersy-plyr-title d-flex">
            ...
            <div class="col-md-5 col-6 position-relative BorderMobil">
                @foreach ($fixture_squad_teamTwo as $tm1)
                    ...
                    <span class="player-jersy-list" data-id="{{ $tm1->player_id }},{{ $teamTwo->id }}">
                        <div class="jersy-img-wrap mb-2">
                            <span class="jersy-no team-jersy-right jersy2">
                                @if ($team_member->jersey_number)
                                    {{ $team_member->jersey_number }}
                                ...
                                @else
                                    @if ($voting == null)
                                        <div class="player-jersy-list"
                                            ...
                                            wire:click="hello({{ $tm1->attendee_id }}, {{ $teamOne->id }})">
                                        @else
                ...
                @else
                    @if ($voting == null)
                        <div class="player-jersy-list"
                            ...
                            wire:click="hello({{ $tm2->attendee_id }}, {{ $teamTwo->id }})">
                        @else
