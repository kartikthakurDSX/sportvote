...
<div class="header-bottom">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1><span class="icon-noun-s icon-noun-circle noun_Trophy"></span><strong>All Competitions </strong></h1>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            @if ($all_comp->isNotEmpty())
                                        ...
                                        @if ($tm->is_active == 1)
                                            <tr>
                                                ...
                                                @if ($tm->comp_type_id == 1)
                                                    ...
                                                    ?> <td><a class="btn btn-success btn-xs-nb"
                ...
                <div class="paginationCustomSvg">
                    {{ $all_comp->links('cpag.custom') }}
                </div>
            @else
                No Data Found!!
            @endif
