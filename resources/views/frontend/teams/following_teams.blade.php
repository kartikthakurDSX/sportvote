...
<div class="header-bottom">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1><span class="icon-noun-s icon-noun-circle noun_Trophy"></span><strong>Teams I Follow</strong></h1>
            </div>
        </div>
    </div>
</div>
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ URL::to('team/' . $tm->team->id) }}" class="btn btn-success btn-xs-nb" target="_blank">View</a>
                                    </tr>
                                    <?php $i++; ?>
                                    @endforeach
                                </tbody>
