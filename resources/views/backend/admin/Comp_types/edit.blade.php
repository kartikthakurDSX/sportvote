...
<div class="page-wrapper   p-b-100 font-robo " style="margin-top:50px;">
    <div class="wrapper wrapper--w680">
        <div class="card card-1">
            ...
            <div class="card-body">
                <h2 class="title">Update Competition Type</h2>
                <form method="POST" action="{{url('admin/comp-type/'.$competitionTypes->id.'/update')}}" enctype="multipart/form-data">
                    @csrf


                    <div class="col-12 ">
                        <label for="" class="mb-2">Competition Type Name</label>
                        <input name="name" class="effect-10 rounded" type="text" placeholder="Competition type" value="{{$competitionTypes->name}}">
                    ...
                    <div class="col-12 mt-2">
                        ...
                        <textarea name="description" placeholder="Description..">{{$competitionTypes->name}}</textarea>
...
<label for="" class="mb-2">Select comp Type icon</label>
                    ...
                    <div style="align-item:center;justify-item:center" >
                         <img id="blah" class="rounded-circle mt-2" src="{{ asset('backend/competition_types/images/' . $competitionTypes->icon) }}" height="100px" width="100px" style="margin-left: 40%;"/>
                    </div>
