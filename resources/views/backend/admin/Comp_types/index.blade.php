    ...
    <div class="container">
                ...
                <table class="w-full whitespace-no-wrap">
                    <thead>
                        ...
                        <tr
                            ...
                            <th class="px-4 py-3">
                                <a href="{{ url('admin-add-compType') }}"><button class="add-attitude-btn"
                                        role="button">Create
                                        +</button>
                                </a>
                            </th>
        ...
        <td class="px-4 py-3 text-sm">
            <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                <img class="object-cover w-full h-full rounded-full"
                    src="{{ asset('backend/competition_types/images/' . $module->icon) }}" alt="" loading="lazy" />
        ...
        <td class="px-4 py-3">
            <div class="flex items-center space-x-4 text-sm">
                ...
                <a href="{{ url('admin/comp-type/' . $module->id . '/edit') }}">
                    <button
                ...
                <form action="{{ url('admin/comp-type/' . $module->id . '/delete') }}" method="POST"
