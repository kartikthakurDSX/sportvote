    ...
    <div class="container">
        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs">
            <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap tbl">
                    <thead>
                        <tr>
                            <th colspan="8">
                        ...
                        <tr rowspan="6">
                            <div class="position-absolute  end-0" style="top:30px;">

                            </div>
                        </tr>
                        <tr
                            class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                            <th class="px-4 py-3">Sports Name</th>
                            <th class="px-4 py-3">Description</th>
                            {{-- <th class="px-4 py-3">Status</th> --}}
                            <th class="px-4 py-3">Icon</th>
                            <th class="px-4 py-3">Actions</th>
                            <th class="px-4 py-3">
                                <a href="{{ url('admin-add-sports') }}"><button class="add-attitude-btn"
                                        role="button">Create
                                        +</button>
                                </a>
                            </th>
                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <div class="flex items-center text-sm">
                                        ...
                                        <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                            <img class="object-cover w-full h-full rounded-full"
                                                src="{{ asset('backend/sports/images/' . $sport->icon) }}" alt=""
                                                loading="lazy" />
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center space-x-4 text-sm">
                                        ...
                                        <a href="{{url('admin/sport/'.$sport->id.'/edit')}}">
                                            <button
                                        ...
                                        <form action="{{url('admin/sport/'.$sport->id.'/delete')}}" method="POST"
