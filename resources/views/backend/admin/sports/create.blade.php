    ...
    <div class="wrapper wrapper--w680">
        <div class="card card-1">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ url('admin-create-sports')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="col-12">
                        <label for="" class="mb-2 mt-2">Sport Name</label>
                        <input name="name" class="effect-10 rounded" type="text" placeholder="Sport Name">
...
<div class="col-12">
                    ...
                    <div style="align-item:center;justify-item:center" >
                         <img id="blah" class="rounded-circle" src="#" height="100px" width="100px" style="margin-left: 40%;"/>
                    </div>
