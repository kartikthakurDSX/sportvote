...
<div class="page-wrapper   p-b-100 font-robo " style="margin-top:50px;">
    <div class="wrapper wrapper--w680">
        <div class="card card-1">
            ...
            <div class="card-body">
                <h2 class="title">Update Notify Module</h2>
                <form method="POST" action="{{url('admin/notify-module/'.$NotifyModule->id.'/update')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="col-12">
                         <label for="" class="mb-2">Notify Module Name</label>
                        <input name="name" class="effect-10 rounded" type="text" placeholder="Notify Module Name" value="{{$NotifyModule->name}}">
                    ...
                    <div class="input-groups">
                        ...
                        <textarea name="description" placeholder="Description..">{{$NotifyModule->description}}</textarea>
