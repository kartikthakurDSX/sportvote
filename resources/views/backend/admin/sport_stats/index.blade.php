            ...
            <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                    <thead>
                        <tr>
                            <th colspan="8">
                                <h4 class="text-lg font-semibold text-light-600 dark:text-light-300 heading">                               Sport Stats
                                </h4>
                            </th>
                        </tr>
                        ...
                        <thead>
                            <tr
                                ...
                                <th class="px-4 py-3">Stats Name</th>
                                <th class="px-4 py-3">Description</th>
                                <th class="px-4 py-3">Sport Name</th>
                                <th class="px-4 py-3">Stat Type</th>
                                {{-- <th class="px-4 py-3">Status</th> --}}
                                <th class="px-4 py-3">Actions</th>
                                <th class="px-4 py-3">
                                    <a href="{{ url('admin.add-sportStats') }}"><button class="add-attitude-btn"
                                            role="button">Create
                                            +</button>
                                    </a>
                                </th>
                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                <td class="px-4 py-3">
                                    <div class="flex items-center text-sm">
                                        ...
                                        <div>
                                            <p class="font-semibold">{{ $sportStat->name }}</p>
                                ...
                                {{-- <td>
                                    <div class="checkbox-wrapper-56">
                                        <label class="container">
                                            <input type="checkbox" data-id="{{ $sportStat->id }}" class="toggle-class"
                                                data-toggle="toggle" data-on="Active" data-off="InActive"
                                                {{ $sportStat->is_active ? 'checked' : '' }}>
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center space-x-4 text-sm">
                                        ...
                                        <a href="{{url('admin/sport-stats/'.$sportStat->id.'/edit')}}">
                                            <button
                                        ...
                                        <form action="{{url('admin/sport-stats/'.$sportStat->id.'/delete')}}" method="POST"
