...
<h4 class="text-lg font-semibold text-light-600 dark:text-light-300 heading">                    Sports Levels
                </h4>
                        </th>
                    </tr>
                    ...
                    <tr
                        ...
                        <th class="px-4 py-3">
                            <a href="{{ url('admin-add-sportLevel') }}"><button class="add-attitude-btn"
                                    role="button">Create
                                    +</button>
                            </a>
                        </th>
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    ...
                                    <a href="{{'admin/sport-level/'.$sport->id.'/edit'}}">
                                        <button
                                    ...
                                    <form action="{{url('admin/sport-level/'.$sport->id.'/delete')}}" method="POST"
