...
<div class="page-wrapper   p-b-100 font-robo " style="margin-top:50px;">
    <div class="wrapper wrapper--w680">
        <div class="card card-1">
            ...
            <div class="card-body">
                <h2 class="title">Add Sport Level</h2>
                <form method="POST" action="{{url('admin-create-sportLevel')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="col-12">
                        <label for="" class="mb-2">Sport Level Name</label>
                        <input name="name" class="effect-10 rounded" type="text" placeholder="sport level name">
