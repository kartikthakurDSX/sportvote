...
<div class="page-wrapper   p-b-100 font-robo " style="margin-top:50px;">
    <div class="wrapper wrapper--w680">
        <div class="card card-1">
            ...
            <div class="card-body">
                <h2 class="title">Update Sport Attitude</h2>
                <form method="POST" action="{{url('admin/sport-attitude/'.$sport->id.'/update')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="col-12">
                        <label for="" class="mb-2 mt-2">Sport Attitude Name</label>
                        <input name="name" class="effect-10 rounded" type="text" placeholder="Sport Attitude Name" value="{{$sport->name}}">
