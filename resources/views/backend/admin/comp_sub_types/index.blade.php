                ...
                <table class="w-full whitespace-no-wrap">
                    ...
                    <thead>
                        ...
                        <tr
                            ...
                            <th class="px-4 py-3">Competition Type</th>
                            <th class="px-4 py-3">Team-Number</th>
                            {{-- <th class="px-4 py-3">Status</th> --}}
                            <th class="px-4 py-3">Actions</th>
                            <th class="px-4 py-3">
                                <a href="{{ url('admin-add-compSubtype') }}"><button class="add-attitude-btn"
                                        role="button">Create
                                        +</button>
                                </a>
                            </th>
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        @foreach ($compSubtypes as $module)
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    {{ $module->team_number }}
                                    {{-- @php
                          $team_number = explode('-', $module->team_number);
                        ...
                        @endfor --}}
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center space-x-4 text-sm">
                                        ...
                                        <a href="{{ url('admin/comp-sub-type/' . $module->id . '/edit') }}">
                                            <button
                                        ...
                                        <form action="{{ url('admin/comp-sub-type/' . $module->id . '/delete') }}"
