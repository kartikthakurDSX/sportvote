...
<div class="page-wrapper   p-b-100 font-robo " style="margin-top:50px;">
    <div class="wrapper wrapper--w680">
        <div class="card card-1">
            <div class="card-body">
                <h2 class="title">Add Competition Sub-Type</h2>
                <form method="POST" action="{{url('admin-create-compSubtype')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="col-12">
                        <label for="" class="mb-2">Competition Sub Type</label>
                        <input name="name" class="effect-10 rounded" type="text" placeholder="Competition sub type">
     ...
     <label for="" class="mt-1">Select Competition Type</label>
                        ...
                        <div class="select">
                            <select name="competition_type_id" class="rounded" id="standard-select">
                                ...
                                @foreach ($competitionTypes as $compType)
                    ...
                    <div class="col-12 mt-3">
                        ...
                        <input name="min_number" class="effect-10 rounded" type="number" placeholder="Minimum Team">
                        <span class="focus-bg"></span>
                    </div>
                    ...
                    <div class="col-12 mt-3">
                        ...
                        <input name="max_number" class="effect-10 rounded" type="number" placeholder="Maximum Team">
                        <span class="focus-bg"></span>
                    </div>
