                ...
                <table class="w-full whitespace-no-wrap">
                    <thead>
                        ...
                        <tr
                            ...
                            <th class="px-4 py-3"> Ground Position Name</th>
                            {{-- <th class="px-4 py-3">Description</th> --}}
                            <th class="px-4 py-3">Sport Ground Map</th>
                            <th class="px-4 py-3">Ground Coordinates</th>
                            {{-- <th class="px-4 py-3">Status</th> --}}
                            <th class="px-4 py-3">Actions</th>
                            <th class="px-4 py-3">
                                <a href="{{ url('admin-add-sportGroundPositions') }}"><button class="add-attitude-btn"
                                        role="button">Create
                                        +</button>
                                </a>
                            </th>
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        @foreach ($SportGroundPositions as $SportGroundPosition)
                            <tr class="text-gray-700 dark:text-gray-400">
                                <td class="px-4 py-3">
                                    <div class="flex items-center text-sm">
                                        <div>
                                            <p class="font-semibold">{{ $SportGroundPosition->name }}</p>
                                ...
                                <td class="px-4 py-3 text-sm">
                                    ...
                                    @foreach ($SportGroundMaps as $sportmap)
                                    @if ($SportGroundPosition->sport_ground_map_id==$sportmap->id)
                                    {{$sportmap->name}}
                                ...
                                {{-- <td>
                                    <div class="checkbox-wrapper-56">
                                        <label class="container">
                                            <input type="checkbox" data-id="{{ $SportGroundPosition->id }}"
                                                class="toggle-class" data-toggle="toggle" data-on="Active"
                                                data-off="InActive"
                                                {{ $SportGroundPosition->is_active ? 'checked' : '' }}>
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center space-x-4 text-sm">
                                        ...
                                        <a href="{{url('admin/sport-ground-position/'.$SportGroundPosition->id.'/edit')}}">
                                            <button
                                        ...
                                        <form
                                            action="{{url('admin/sport-ground-position/'.$SportGroundPosition->id.'/delete')}}"
