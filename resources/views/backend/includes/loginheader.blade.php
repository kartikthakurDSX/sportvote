...
<head>
  ...
  <link href="{{url('backend/css/custom_css.css')}}" rel="stylesheet">
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <!-- <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__shake" src="{{url('frontend/images/logo.png')}}" alt="AdminLTELogo" height="160" width="360">
    </div>   -->