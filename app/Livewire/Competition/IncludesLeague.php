...
class IncludesLeague extends Component
{
    public $comp_id;
    public $body;
    public $is_save = 1;
    ...
    public function render()
    {
        ...
        return view('livewire.competition.includes-league', compact('competition', 'admins', 'competition_member', 'comp_referee', 'comp_activeRefree', 'comp_sponsers', 'competition_video', 'video', 'comp_rules', 'comp_rules_paragraph'));
    }

    // for about us edit description
    ...
    // for about us edit description ending
    ...
    //for comp sponsors ending
    //for comp youTube video
