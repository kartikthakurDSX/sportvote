...
class TeamFollow extends Component
{
    ...
    protected $messages = [
        ...
        'team_name.max' => 'Team Name must not be greater than 30 characters.',
    ...
    public function join_team()
    {
        ...
        if($this->join_member_position1 != ''){
            $team_member->alt_member_position_id1 = $this->join_member_position1;
        }
        if($this->join_member_position2 != ''){
            $team_member->alt_member_position_id2 = $this->join_member_position2;
        }
